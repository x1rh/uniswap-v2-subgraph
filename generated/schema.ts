...
export class Pair extends Entity {
  ...
  get PairMinuteData(): PairMinuteDataLoader {
    return new PairMinuteDataLoader(
      "Pair",
      this.get("id")!.toString(),
      "PairMinuteData",
    );
...
export class PairMinuteData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PairMinuteData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type PairMinuteData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("PairMinuteData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): PairMinuteData | null {
    return changetype<PairMinuteData | null>(
      store.get_in_block("PairMinuteData", id),
    );
  }

  static load(id: string): PairMinuteData | null {
    return changetype<PairMinuteData | null>(store.get("PairMinuteData", id));
  }
...
export class TokenMinuteData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save TokenMinuteData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type TokenMinuteData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("TokenMinuteData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): TokenMinuteData | null {
    return changetype<TokenMinuteData | null>(
      store.get_in_block("TokenMinuteData", id),
    );
  }

  static load(id: string): TokenMinuteData | null {
    return changetype<TokenMinuteData | null>(store.get("TokenMinuteData", id));
  }
  ...
  set buyTxs(value: BigInt) {
    this.set("buyTxs", Value.fromBigInt(value));
  }

  get sellTxs(): BigInt {
    let value = this.get("sellTxs");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set sellTxs(value: BigInt) {
    this.set("sellTxs", Value.fromBigInt(value));
  }

  get buyVolumeUSD(): BigDecimal {
    let value = this.get("buyVolumeUSD");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set buyVolumeUSD(value: BigDecimal) {
    this.set("buyVolumeUSD", Value.fromBigDecimal(value));
  }

  get sellVolumeUSD(): BigDecimal {
    let value = this.get("sellVolumeUSD");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set sellVolumeUSD(value: BigDecimal) {
    this.set("sellVolumeUSD", Value.fromBigDecimal(value));
  }
}
...
export class PairMinuteDataLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): PairMinuteData[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<PairMinuteData[]>(value);
  }
}
